...
import { Button, Nav, UncontrolledDropdown } from 'reactstrap';
        ...
        <div className="profilebg" style={{ background: `url(${probg}) no-repeat` }}>
          ...
          <Dropdown isOpen={isOpen5} toggle={toggle5.bind(null)}>
            ...
            <DropdownMenu className='start-50 profile-dropdown shadow-lg'>
              ...
              <div className="dropdown-divider"></div>
              <DropdownItem href='/auth/loginformik' className='dropdown-item d-flex align-items-center gap-2 py-2'>
        ...
        <div className="p-3 pt-1 mt-2">
          <Nav vertical className={activeBg === 'white' ? '' : 'lightText'}>
            {SidebarData.map((navi) => {
              if (navi.caption) {
                return (
                  <div className="navCaption text-dark text-uppercase mt-4" key={navi.caption}>
                    {navi.caption}
                  </div>
                );
              }
