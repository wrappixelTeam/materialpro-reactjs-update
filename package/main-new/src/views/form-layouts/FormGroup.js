      ...
      <Row>
        <Col sm="12" md="6">
          ...
          >
            <Form>
              <InputGroup>
                <Dropdown isOpen={dropdownOpen} toggle={toggleDropDown.bind(null)}>
        ...
        <Col sm="12" md="6">
          ...
          >
            <Form>
              <InputGroup>
                <Input />
                <Dropdown isOpen={dropdownOpen1} toggle={toggleDropDown1.bind(null)}>
                  <DropdownToggle caret>Dropdown</DropdownToggle>
                  <DropdownMenu>
                    <DropdownItem header>Header</DropdownItem>
                    <DropdownItem disabled>Action</DropdownItem>
        ...
        <Col sm="12" md="6">
          ...
          >
            <Form>
              <InputGroup>
                <Dropdown group isOpen={splitButtonOpen} toggle={toggleSplit.bind(null)}>
        ...
        <Col sm="12" md="6">
          ...
          >
            <Form>
              <InputGroup>
                <Input />
                <Dropdown group isOpen={splitButtonOpen1} toggle={toggleSplit1.bind(null)}>
                  <Button outline>Split Button</Button>
                  <DropdownToggle split outline />
                  <DropdownMenu>
                    <DropdownItem header>Header</DropdownItem>
