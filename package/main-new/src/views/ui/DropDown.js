      ...
      <Row>
        ...
        <Col xs="12" md="6">
          ...
          <ComponentCard title="Split Button Dropdowns">
            <div className="d-flex align-items-center gap-3">
              <Dropdown group isOpen={isOpen1} toggle={toggle1}>
              ...
              <Dropdown group isOpen={isOpen2} toggle={toggle2}>
              ...
              <Dropdown group isOpen={isOpen3} toggle={toggle3}>
        ...
        <Col xs="12" md="6">
          ...
          <ComponentCard title="Sizing Dropdowns">
            <div className="d-flex align-items-center gap-3">
              <Dropdown isOpen={isOpen4} toggle={toggle4}>
              ...
              <Dropdown isOpen={isOpen5} toggle={toggle5}>
        ...
        <Col xs="12" md="6">
          ...
          <ComponentCard title="Drop Direction Variations">
            <div className="d-flex align-items-center gap-3">
              <Dropdown direction="up" isOpen={isOpen6} toggle={toggle6}>
              ...
              <Dropdown direction="start" isOpen={isOpen7} toggle={toggle7}>
              ...
              <Dropdown direction="end" isOpen={isOpen8} toggle={toggle8}>
