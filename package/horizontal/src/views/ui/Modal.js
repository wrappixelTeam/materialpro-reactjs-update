      ...
      <Row>
        ...
        <Col xs="12" md="6">
          <ComponentCard title="Fullscreen">
            <Button color="primary" onClick={toggle8.bind(null)}>
              Launch Modals with Fullscreen
            </Button>
            <Modal isOpen={modal8} toggle={toggle8.bind(null)} fullscreen>
        ...
        <Col xs="12" md="6">
          <ComponentCard title="Fadeless Modals">
            <Button color="primary" onClick={toggle9.bind(null)}>
              Launch Fadeless Modals
            </Button>
            <Modal isOpen={modal9} fade={false} toggle={toggle9.bind(null)}>
              <ModalHeader toggle={toggle9.bind(null)} charCode="Y">
                Modal title
              </ModalHeader>
              <ModalBody>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
        ...
        <Col xs="12" md="6">
          <ComponentCard title="Backdrop">
            <Form className="d-flex align-items-center" onSubmit={(e) => e.preventDefault()}>
              ...
              <Button color="primary" className="ms-2 mt-3" onClick={toggle2.bind(null)}>
                Launch Modal
              </Button>
            </Form>
