      ...
      <Row>
        ...
        <Col xs="12" md="6">
          ...
          <ComponentCard title="Split Button Dropdowns">
            <div className="d-flex align-items-center gap-3">
              ...
              <Dropdown group isOpen={isOpen2} toggle={toggle2.bind(null)}>
              ...
              <Dropdown group isOpen={isOpen3} toggle={toggle3.bind(null)}>
        ...
        <Col xs="12" md="6">
          ...
          <ComponentCard title="Sizing Dropdowns">
            <div className="d-flex align-items-center gap-3">
              <Dropdown isOpen={isOpen4} toggle={toggle4.bind(null)}>
        ...
        <Col xs="12" md="6">
          ...
          <ComponentCard title="Drop Direction Variations">
            <div className="d-flex align-items-center gap-3">
              <Dropdown direction="up" isOpen={isOpen6} toggle={toggle6.bind(null)}>
              ...
              <Dropdown direction="start" isOpen={isOpen7} toggle={toggle7.bind(null)}>
              ...
              <Dropdown direction="end" isOpen={isOpen8} toggle={toggle8.bind(null)}>
